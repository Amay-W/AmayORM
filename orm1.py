...
customer1 = Customer(Name='Michael Scott', Email='michael@example.com', Phone='987654321', Address='123 Scranton Ave')
customer2 = Customer(Name='Jim Halpert', Email='jim@example.com', Phone='123456789', Address='456 Stamford St')

session.add_all([customer1, customer2])

session.commit()

order1 = Order(CustomerID=customer1.CustomerID, Product='Paper', Quantity=100, OrderDate=datetime.strptime('2023-01-01', '%Y-%m-%d').date())
order2 = Order(CustomerID=customer1.CustomerID, Product='Stapler', Quantity=2, OrderDate=datetime.strptime('2023-02-15', '%Y-%m-%d').date())
order3 = Order(CustomerID=customer2.CustomerID, Product='Desk Chair', Quantity=1, OrderDate=datetime.strptime('2023-03-10', '%Y-%m-%d').date())
